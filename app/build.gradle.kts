...
android {
    namespace = "com.nhinhnguyenuit.weatherapptest"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.nhinhnguyenuit.weatherapptest"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
        ...
        val localPropertiesFile = File(rootProject.rootDir,"apikeys.properties")
